...
session are used to store information about what the site does for a given logged in user.

1. What does bcrypt do to help us store passwords in a secure manner.

hashes the password with a salt so they are unique and harder to guess

1. What does bcrypt do to slow down attackers?

runs on js which makes it 30% slower
